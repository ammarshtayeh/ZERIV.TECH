...
> = {
  web: {
    title: "تطوير الويب",
    line: "سريع وبنيوي وقابل للتوسع — Next.js وReact وTypeScript.",
  ...
  mobile: {
    ...
    line: "واجهات أصلية سلسة لـ iOS وAndroid من قاعدة واحدة.",
  ...
  ai: {
    title: "حلول الذكاء",
    line: "نماذج ووكلاء وأنابيب مربوطة بمنتجات حقيقية.",
    items: ["دمج نماذج لغوية", "أتمتة", "أنابيب بيانات", "ذكاء المنتج"],
    audience: "منتجات تحتاج ذكاءً مدمجاً — لا ملحقاً شكلياً.",
    includes: [
      "ميزات منتج مدعومة بنماذج لغوية",
      "أتمتة سير العمل",
      "أنظمة محتوى ومعرفة",
      "أنماط تقييم ونشر آمن",
    ],
  },
  creative: {
    title: "تكنولوجيا إبداعية",
    line: "WebGL وأنظمة توليدية وتجارب لا يُفترض أن تعمل في المتصفح.",
    items: ["WebGL", "أنظمة توليدية", "تركيبات", "واجهات تجريبية"],
    audience: "علامات ومؤسسات تحتاج لحظة رقمية مميزة — قابلة للتذكر ومحكومة.",
    includes: [
      "تجارب ويب تفاعلية",
      "مرئيات WebGL وتوليدية",
      "أسطح حملات وإطلاق",
      "مفاهيم معارض وتركيبات",
    ],
  },
};
