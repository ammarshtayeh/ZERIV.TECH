      ...
      <Container className="relative z-10">
        <ScrollReveal>
          <div className="mb-20 sm:mb-28 text-right">
            ...
            <p className="mt-6 max-w-xl text-sm leading-relaxed text-white/40 font-light">
            ...
            <div className="relative h-full rounded-2xl border border-white/[0.06] bg-[#0f0f0f] p-8 flex flex-col justify-between transition-all duration-500 hover:border-[#007a3d]/30">
              <div>
                <div className="flex items-center justify-between flex-row-reverse border-b border-white/[0.06] pb-4 mb-6">
                  ...
                  <h3 className="font-display text-lg font-bold text-white">التناغم والتناسب</h3>
                </div>
                ...
                <div className="h-36 w-full bg-black/40 rounded-xl flex items-center justify-center border border-white/[0.04] relative overflow-hidden">
                  <svg className="h-28 w-28 opacity-70" viewBox="0 0 100 100" fill="none">
                    {/* Outer elegant arch */}
                    <motion.path 
                ...
                <p className="mt-6 text-xs leading-relaxed text-white/40 text-right font-light" dir="rtl">
            ...
            <div className="relative h-full rounded-2xl border border-white/[0.06] bg-[#0f0f0f] p-8 flex flex-col justify-between transition-all duration-500 hover:border-[#ce1126]/30">
              <div>
                <div className="flex items-center justify-between flex-row-reverse border-b border-white/[0.06] pb-4 mb-6">
                  ...
                  <h3 className="font-display text-lg font-bold text-white">النمو والصمود</h3>
                </div>
            ...
            <div className="relative h-full rounded-2xl border border-white/[0.06] bg-[#0f0f0f] p-8 flex flex-col justify-between transition-all duration-500 hover:border-[#007a3d]/30">
              <div>
                <div className="flex items-center justify-between flex-row-reverse border-b border-white/[0.06] pb-4 mb-6">
                  ...
                  <h3 className="font-display text-lg font-bold text-white">التفاصيل والصنعة</h3>
                </div>
        ...
        {fullPage && (
          <ScrollReveal className="mt-16 text-center">
            <div className="inline-flex flex-col items-center max-w-xl mx-auto rounded-2xl border border-white/[0.06] bg-[#0f0f0f]/30 p-8 sm:p-10 backdrop-blur-sm">
              <h4 className="font-display text-lg font-bold text-white mb-4">هندسة تفوق المألوف</h4>
