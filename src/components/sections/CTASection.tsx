      ...
      <Container className="relative z-10">
        <ScrollReveal>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="mt-6 text-base font-light text-white/40">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/portfolio"
                className="inline-flex items-center gap-2 rounded-full border border-white/10 px-7 py-4 text-sm font-semibold text-white/50 transition-all duration-500 hover:border-[#007a3d]/30 hover:text-[#007a3d]"
              >
                شاهد أعمالنا
              </Link>
            </div>
